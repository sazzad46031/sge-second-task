            ...
            <div className='text-center max-w-screen-xl lg:mx-auto mx-5'>
                <form>
                    ...
                    <div className='pt-[55px]'>
                        <button className='lg:poppnis-bold mulish-regular lg:text-[18px] text-[14px] lg:px-[81px] lg:py-[22px] px-[17px] py-2 bg-[#2563EB] hover:bg-[#3D7DED] text-white rounded-[32px]'>Book Free Counselling</button>
                    </div>
                </form>
            </div>
