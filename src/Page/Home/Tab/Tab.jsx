            ...
            <div className="tab-content tab-1 color_div text-center lg:text-left mb-[56px]">
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-[28px]'>
                    <div className='order-2 lg:order-1'>
                        ...
                        <button className='bg-[#2563EB] mulish-regular lg:text-[21px] text-[14px] text-white rounded-[32px] lg:px-[85px] px-10 lg:py-2 py-[3px] mt-6 mx-auto'>Start Now</button>
                    </div>
            ...
            <div className="tab-content tab-2 color_div text-center lg:text-left">
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-[28px]'>
                    <div className='order-2 lg:order-1'>
                        ...
                        <button className='bg-[#2563EB] mulish-regular lg:text-[21px] text-[14px] text-white rounded-[32px] lg:px-[85px] px-10 lg:py-2 py-[3px] mt-6'>Explore More</button>
                    </div>
                    <div className='order-1 lg:order-2'>
