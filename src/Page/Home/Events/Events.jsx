    ...
    return (
        <div className='events-bg lg:h-[915px] h-[629px] lg:mb-[100px] mb-5 events-width overflow-hidden'>
            ...
            <div className='events-bg max-w-[1254px] mx-auto relative pl-[50px] pr-[50px]'>
                    ...
                    <button className='absolute lg:flex hidden items-center lg:top-60 lg:left-0' onClick={slideNext}>
                    ...
                    <button className='absolute lg:block hidden z-10 lg:right-0 lg:top-60' onClick={slidePrev}>
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button className='absolute lg:hidden block z-10 top-[440px] left-52' onClick={slideNext}>
                    ...
                    <button className='absolute lg:hidden block top-[440px] left-40' onClick={slidePrev}>
                        <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
