...
const Events = () => {
    ...
    return (
        <div className='events-bg lg:h-[915px] h-[629px] mb-[100px] events-width relative overflow-hidden'>
            ...
            <div className='events-bg max-w-[1154px] mx-auto'>
                <div className='absolute left-[50%] -translate-x-1/2 slide-pos-center carousel-1'>
                    <img src="./assets/event1.png" alt="" className='w-[945px] h-[525px]' onClick={slideNext} />
                </div>
                <div className='absolute left-[50%] -translate-x-1/2 slide-pos-right1 carousel-1'>
                    <img src="./assets/event2.png" alt="" className='w-[945px] h-[525px]' onClick={slideNext} />
                </div>
                <div className='absolute left-[50%] -translate-x-1/2 slide-pos-right2 carousel-1'>
                    <img src="./assets/event3.png" alt="" className='w-[945px] h-[525px]' onClick={slideNext} />
                </div>
                <div className='absolute left-[50%] -translate-x-1/2 slide-pos-left1 carousel-1'>
                    <img src="./assets/event4.png" alt="" className='w-[945px] h-[525px]' onClick={slideNext} />
                </div>
                <div className='absolute left-[50%] -translate-x-1/2 slide-pos-left2 carousel-1'>
                    <img src="./assets/event5.png" alt="" className='w-[945px] h-[525px]' onClick={slideNext} />
                </div>
            </div>
            <div className='relative lg:block hidden'>
                <button className='absolute flex items-center lg:top-60 lg:left-[332px]' onClick={slideNext}>
            ...
            <div className='relative lg:block hidden z-10'>
                <button className='absolute lg:right-[332px] lg:top-60' onClick={slidePrev}>
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
